...
*** Keywords ***
Retrieve Vault Value
    ${vault_data}=   Get Secret    vault_data  
    [Return]    ${vault_data}[url]
...
*** Keywords ***
Submit the order
    [Documentation]  Submit order with 10 retries if it fails
    Wait Until Keyword Succeeds    10x    1 sec    Click Submit
...
Order robots from RobotSpareBin Industries Inc    
    ...
    ${vault_result}=  Retrieve Vault Value 
